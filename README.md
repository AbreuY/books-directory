For this project, I'm going to build a book directory RESTApi, where I would need to create endpoints, using the four most basic methods: GET, POST, PUT and DELETE.
